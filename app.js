// PhysicsGuide App Logic

const STORAGE_KEY = 'physicsguide_learned';
...
function renderHome() {
  ...
  hero.innerHTML = `
    <h1>Physics, from <span>nothing to everything</span></h1>
    <p class="hero-sub">One concept at a time. Every idea connected to something you can touch, feel, or see. Short, real, no fluff. Built for how your brain works.</p>
    ...
    <div style="padding:20px;background:var(--bg2);border:1px solid var(--border);border-radius:10px;max-width:600px">
      <div class="detail-label">The Learning Path</div>
      <div style="font-size:13px;color:var(--text-muted);line-height:1.8">
        <strong style="color:var(--text)">1. The Basics</strong> → Matter, mass, units, measurement<br>
        <strong style="color:var(--text)">2. Motion & Forces</strong> → How things move and why<br>
        <strong style="color:var(--text)">3. Energy & Momentum</strong> → The fuel and impact of motion<br>
        <strong style="color:var(--text)">4. Rotation & Torque</strong> → Levers, catapults, and angular motion<br>
...
function tagLabel(tag) {
  return { intro: 'Intro', core: 'Core', univ: 'University', applied: 'Applied' }[tag] || tag;
}
