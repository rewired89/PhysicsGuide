...
const SECTIONS = [
...

  {
    ...
    subtitle: "Superposition, entanglement, tunneling, orbitals — the rules that govern the very small",
    concepts: [

      {
        id: "quantum-states-superposition",
        title: "Quantum States & Superposition",
        tags: ["core"],
        chain: ["Classical: object has one definite state", "Quantum: object exists in multiple states at once", "Superposition = all states simultaneously", "Measurement collapses to one outcome", "Probability determines which outcome"],
        blurb: "A quantum particle doesn't have one definite state until you measure it — it exists as a superposition of all possible states at once. Measurement forces it to 'choose', and quantum mechanics predicts the probabilities.",
        detail: `Classical physics assumes objects always have definite properties: a coin is heads or tails, never both. Quantum mechanics breaks this assumption at the microscopic scale.\n\n<strong>Superposition:</strong>\nA quantum system can exist in a combination (superposition) of multiple states simultaneously. An electron's spin can be "up", "down", or — before measurement — both at once.\nMathematically: |ψ⟩ = α|0⟩ + β|1⟩\nα and β are complex amplitudes. |α|² + |β|² = 1 (probabilities sum to 1).\n\n<strong>Measurement and collapse:</strong>\nBefore measurement, the electron is in superposition. The instant you measure spin, the wavefunction "collapses" to one definite outcome — up or down — with probabilities |α|² and |β|².\nThe act of measurement is irreversible and physically changes the system. This is not a limitation of instruments — it is fundamental.\n\n<strong>Schrödinger's Cat (thought experiment):</strong>\nA cat in a sealed box, connected to a quantum decay trigger: alive and dead simultaneously until the box is opened. This highlights the absurdity of applying quantum superposition to everyday objects. The "many worlds" and "Copenhagen" interpretations offer different explanations for why we never see macroscopic superpositions.\n\n<strong>Why superposition exists at quantum scales but not everyday scales:</strong>\nDecoherence: quantum systems constantly interact with their environment (air molecules, photons, thermal noise). These interactions rapidly destroy superposition — converting quantum probabilities to classical certainties. Large objects decohere in femtoseconds. Isolated quantum systems can maintain superposition much longer.\n\n<strong>Quantum computing exploits superposition:</strong>\nA classical bit is 0 or 1. A qubit (quantum bit) can be in superposition of 0 and 1 simultaneously. n qubits can represent 2ⁿ states at once, allowing certain computations to be exponentially faster.`,
        memory: `Imagine a coin spinning in the air — it's neither heads nor tails yet. When it lands (measurement), it becomes one. A quantum particle is like a permanently spinning coin that only picks heads or tails the instant you catch it. The probability of each outcome is encoded in the wave function. But unlike a spinning coin, this isn't due to ignorance of the coin's state — the quantum superposition is real, and interference experiments prove it.`,
        examTip: `Quantum coherence in biology is an active research frontier. Photosynthesis (in plants and bacteria) may exploit quantum superposition to route energy through multiple pathways simultaneously, finding the optimal path with near-perfect efficiency. Studies on bird magnetoreception suggest quantum entanglement of electrons in cryptochrome proteins may underlie compass sensing. These are controversial but measurable — quantum biology is a real and growing field.`,
        facts: ["Superposition: multiple states simultaneously", "|ψ⟩ = α|0⟩ + β|1⟩", "Measurement collapses wavefunction", "Decoherence destroys quantum states", "Qubit exploits superposition for computing", "Schrödinger's cat: macroscopic superposition thought experiment"]
      },

      {
        ...
        tags: ["univ"],
        chain: ["Classical mechanics: F = ma for particles", "Wave mechanics: ψ describes quantum state", "Schrödinger equation: how ψ evolves in time", "Solve it → probability map for particle", "Solutions reveal energy levels and orbitals"],
        blurb: "The Schrödinger equation is to quantum mechanics what Newton's second law is to classical mechanics — it describes how a quantum system evolves over time. Its solutions give the probability of finding a particle anywhere in space.",
        detail: `The time-dependent Schrödinger equation:\niħ ∂ψ/∂t = Ĥψ\n\ni = imaginary unit, ħ = h/2π (reduced Planck), ψ = wave function, Ĥ = Hamiltonian operator (total energy)\n\n<strong>What it means:</strong>\nThe left side: iħ ∂ψ/∂t — how the wave function changes with time.\nThe right side: Ĥψ — the total energy operator acting on the wave function.\nThe equation says: the way the quantum state evolves is governed entirely by the system's energy.\n\n<strong>The wave function ψ:</strong>\nψ is a complex-valued function of position and time.\n|ψ(x,t)|² = probability density of finding the particle at position x at time t.\nψ itself has no direct physical meaning — only |ψ|² is observable (Born rule).\n\n<strong>Time-independent Schrödinger equation (stationary states):</strong>\nĤψ = Eψ\nThis is an eigenvalue equation. Solutions ψ_n are stationary states with definite energies E_n.\nSolving for a hydrogen atom gives exactly the energy levels: E_n = −13.6 eV / n²\nPredicting atomic spectra from first principles — this matched experiment perfectly.\n\n<strong>Solving the equation — particle in a box:</strong>\nAn electron confined to a box of width L can only have energies: E_n = n²h²/(8mL²)\nEnergy is quantized — only discrete values allowed. The smaller the box, the higher the minimum energy (zero-point energy). This explains why electrons in atoms have minimum energies and don't spiral into the nucleus.\n\n<strong>Operators and observables:</strong>\nIn quantum mechanics, measurable quantities (position, momentum, energy) are represented by mathematical operators. Measuring = applying the operator to ψ. The result is always an eigenvalue of that operator.`,
        memory: `Think of the Schrödinger equation like a wave equation for probability. Just as a water wave equation predicts where wave crests will be after time t, the Schrödinger equation predicts where the probability of finding a particle is highest after time t. The wave doesn't carry water — it carries probability amplitude. Solve the equation, square the result, and you have a probability map of where the particle will be found.`,
        examTip: `The Schrödinger equation directly predicts atomic orbitals — the shapes of s, p, d, f orbitals come directly from solving it for the hydrogen atom. These orbital shapes determine chemical bonding, molecular geometry, and the properties of all materials. Every molecular dynamics simulation in bioinformatics is ultimately running a simplified version of this equation (Born-Oppenheimer approximation: compute electronic energy for each nuclear configuration). Quantum mechanics underlies all of chemistry.`,
        facts: ["iħ∂ψ/∂t = Ĥψ (time-dependent form)", "ψ = wave function (complex-valued)", "|ψ|² = probability density", "Ĥψ = Eψ gives energy levels", "Hydrogen: E_n = −13.6 eV / n²", "Orbitals = solutions to Schrödinger equation"]
      },

      {
        ...
        tags: ["core"],
        chain: ["Classical particle: can't cross an energy barrier", "Quantum particle: wavefunction penetrates barrier", "Non-zero probability of appearing on other side", "Probability depends on barrier width and height", "Makes nuclear fusion, STM, and enzymes possible"],
        blurb: "A quantum particle can pass through an energy barrier it classically has no energy to cross. This tunneling effect is real and measurable — it powers stars, semiconductors, and some enzyme reactions.",
        detail: `In classical mechanics, a ball rolling toward a wall it doesn't have enough energy to climb will always bounce back. Quantum mechanics allows particles to tunnel through such barriers.\n\n<strong>How tunneling works:</strong>\nThe particle's wave function doesn't abruptly stop at the barrier — it decays exponentially inside the barrier and re-emerges on the other side with reduced amplitude.\n|ψ|² on the far side > 0, meaning there is a non-zero probability of finding the particle there.\nThe tunneling probability: T ≈ e^(−2κL)\nκ = √(2m(V−E)/ħ²) — depends on mass m, barrier height V, particle energy E\nL = barrier width\n\n<strong>Key factors:</strong>\n• Thinner barrier → more tunneling\n• Lower mass → more tunneling (electrons tunnel easily; protons tunnel less; baseballs essentially never tunnel)\n• Lower barrier → more tunneling\n\n<strong>Where tunneling matters in reality:</strong>\n\n<strong>Nuclear fusion in stars:</strong>\nProtons in the Sun's core have ~1 keV kinetic energy. The Coulomb barrier between them requires ~100 keV to classically overcome. Yet fusion happens — protons tunnel through the barrier. Without tunneling, stars would not shine.\n\n<strong>Scanning Tunneling Microscope (STM):</strong>\nA sharp metal tip hovers ~0.5 nm above a surface. Electrons tunnel between tip and surface, generating a tiny but measurable current that depends exponentially on distance. Moving the tip over the surface maps individual atoms. First direct imaging of atoms — Nobel Prize 1986.\n\n<strong>Tunnel diodes and transistors:</strong>\nFlash memory stores bits using electron tunneling through a thin oxide layer. Quantum tunneling is what makes modern electronics possible at nanometer scales.\n\n<strong>Enzyme catalysis (quantum biology):</strong>\nSeveral enzymes (alcohol dehydrogenase, aromatic amine dehydrogenase) show kinetic isotope effects consistent with proton/hydrogen tunneling through reaction barriers, enhancing reaction rates beyond classical predictions.`,
        memory: `Ghost-walking through a wall is fiction for you because your mass is ~70 kg. The tunneling probability scales as e^(−2κL), and for a macroscopic object crossing a macroscopic barrier the exponent is ~ −10³⁰ — effectively zero. But an electron (mass 9×10⁻³¹ kg) crossing a 1 nm barrier of modest height has a tunneling probability of a few percent. Physics at the nanoscale is genuinely different from the world you experience.`,
        examTip: `Proton tunneling in DNA is a proposed mechanism for spontaneous mutations. The Watson-Crick base pairs (A-T, G-C) are held by hydrogen bonds. If a proton tunnels to a different position along the hydrogen bond (tautomeric shift), the base pair's hydrogen-bonding pattern changes, potentially causing mispairing during replication. This quantum mechanism for mutation is still debated but physically plausible — quantum mechanics affecting genetic information directly.`,
        facts: ["Particle passes through classically forbidden barrier", "T ≈ e^(−2κL) — exponential in barrier width", "Lower mass = higher tunneling probability", "Enables stellar fusion (proton tunneling)", "STM images individual atoms via tunneling current", "Flash memory uses electron tunneling"]
      },

      {
        ...
        tags: ["univ"],
        chain: ["Two particles interact", "Their quantum states become correlated", "Measuring one instantly defines the other", "No matter the distance", "Einstein called it 'spooky action at a distance'"],
        blurb: "When two particles become entangled, measuring one instantly determines the correlated property of the other — even across any distance. This is experimentally confirmed and forms the basis of quantum cryptography and quantum computing.",
        detail: `Entanglement is perhaps the strangest feature of quantum mechanics — and the most experimentally verified.\n\n<strong>What entanglement is:</strong>\nTwo particles are entangled when their quantum states cannot be described independently. The joint state is:\n|ψ⟩ = (1/√2)(|↑↓⟩ − |↓↑⟩)\nNeither particle has a definite spin — but if you measure particle A as spin-up, particle B is instantly spin-down, regardless of distance.\n\n<strong>The EPR paradox (Einstein, Podolsky, Rosen, 1935):</strong>\nEinstein argued entanglement implied "hidden variables" — that the particles secretly had definite states all along, and measurement just revealed them. No spooky action needed.\n\n<strong>Bell's theorem (1964) and Bell tests:</strong>\nJohn Bell proved that hidden variable theories predict different statistical results than quantum mechanics. Experiments (Aspect 1982, Zeilinger 2022 Nobel Prize) show quantum mechanics is correct. The correlations are real and stronger than any local hidden variable theory allows. Entanglement is a genuine non-classical phenomenon.\n\n<strong>What entanglement does NOT allow:</strong>\nFaster-than-light communication. You cannot control which outcome particle A gets, so you cannot encode a message in the correlations. The correlation is only visible after comparing measurements classically.\n\n<strong>Applications:</strong>\n• Quantum cryptography (QKD): any eavesdropping on an entangled communication channel disturbs the quantum states and is detectable — physically guaranteed security.\n• Quantum teleportation: transfer of a quantum state (not matter or FTL information) between locations using entanglement + a classical channel.\n• Quantum computing: entangled qubits can represent exponentially more states; quantum algorithms (Shor's, Grover's) exploit entanglement for speed-up.`,
        memory: `Imagine two magic gloves put in separate boxes. You send one box to Tokyo, open yours, and see a left glove — instantly you know Tokyo has the right glove. Classical correlation: both gloves were always left/right, you just didn't know. Entanglement is different: neither glove was left or right until you opened the box — and the act of opening yours instantly determined Tokyo's. Bell's experiments proved it's the second scenario, not the first. The universe is that strange.`,
        examTip: `Quantum sensing uses entanglement to surpass classical measurement limits. Entangled photon pairs allow imaging with better signal-to-noise than classical light. Quantum-enhanced MRI (nitrogen-vacancy centers in diamond, entangled nuclear spins) could detect single molecules, potentially enabling nanoscale imaging of individual proteins in living cells. These are active research areas — quantum mechanics is not just historically interesting, it's the frontier of biological measurement.`,
        facts: ["Entangled particles share a quantum state", "Measuring one instantly defines the other", "Bell tests confirm no hidden variables", "Does NOT allow faster-than-light communication", "Used in quantum cryptography (QKD)", "Quantum computing exploits multi-qubit entanglement"]
      },

      {
        id: "quantum-numbers-orbitals",
        title: "Quantum Numbers & Orbitals",
        tags: ["core"],
        chain: ["Electron in atom → wave equation solution", "4 quantum numbers label the state", "n, l, m_l, m_s fully describe each electron", "Pauli: no two electrons share all four numbers", "Orbital shape determines bonding and chemistry"],
        blurb: "Four quantum numbers describe every electron in an atom. Their allowed combinations define the orbital shapes (s, p, d, f) and explain the entire structure of the periodic table.",
        detail: `Solving the Schrödinger equation for a hydrogen atom produces a set of solutions, each labeled by four quantum numbers.\n\n<strong>Principal quantum number n:</strong>\nn = 1, 2, 3, ... (positive integers)\nDetermines the electron's energy and average distance from nucleus.\nn=1: ground state. n=2: first excited state. Higher n = more energy, farther out.\n\n<strong>Angular momentum quantum number l:</strong>\nl = 0, 1, 2, ..., (n−1)\nDetermines orbital shape.\n• l=0: s orbital — spherical\n• l=1: p orbital — dumbbell-shaped (3 orientations: p_x, p_y, p_z)\n• l=2: d orbital — complex shapes (5 orientations)\n• l=3: f orbital — very complex (7 orientations)\n\n<strong>Magnetic quantum number m_l:</strong>\nm_l = −l, ..., 0, ..., +l\nOrientation of orbital in space relative to a magnetic field.\n\n<strong>Spin quantum number m_s:</strong>\nm_s = +½ (spin up ↑) or −½ (spin down ↓)\nIntrinsic angular momentum of the electron. No classical analogy. Spin is quantized in units of ħ/2.\n\n<strong>Pauli Exclusion Principle:</strong>\nNo two electrons in the same atom can have the same set of all four quantum numbers.\nEach orbital (defined by n, l, m_l) can hold at most 2 electrons (one spin-up, one spin-down).\nThis is why matter is solid (electrons can't all collapse to n=1), why the periodic table has the structure it does, and why chemistry exists.\n\n<strong>Electron configuration and chemistry:</strong>\nFill orbitals lowest energy first (Aufbau principle). Carbon: 1s² 2s² 2p².\nThe number of valence electrons in the outermost shell determines reactivity, bonding type, and the element's chemical identity.`,
        memory: `Think of the atom as a hotel: n = floor number, l = room type (suite/standard/single), m_l = room number on that floor, m_s = which bed. Pauli's rule: no two guests (electrons) can share all four identifiers — same floor, same room type, same room number, same bed. Once a bed is taken, that state is full. This is why atoms build outward — electrons stack up through floors because the lower ones are taken.`,
        examTip: `Molecular orbital theory extends atomic orbitals to molecules. Atomic orbitals combine to form bonding and antibonding molecular orbitals — the basis of all covalent chemistry. In bioinformatics and structural biology, frontier molecular orbital theory (HOMO-LUMO gap) predicts drug reactivity and binding. Density functional theory (DFT), a computational implementation of quantum mechanics, calculates molecular properties for drug discovery — directly connecting quantum numbers to pharmaceutical design.`,
        facts: ["n: energy level (1, 2, 3...)", "l: orbital shape (s/p/d/f)", "m_l: orientation in space", "m_s: spin (+½ or −½)", "Pauli: no two electrons share all 4 numbers", "Each orbital holds max 2 electrons"]
      },

      {
        id: "spin-pauli",
        title: "Spin & the Pauli Exclusion Principle",
        tags: ["univ"],
        chain: ["Electrons have intrinsic angular momentum (spin)", "Spin is quantized: +½ or −½", "Fermions obey Pauli exclusion", "Bosons can stack in same state", "Pauli exclusion makes matter solid"],
        blurb: "Spin is an intrinsic quantum property with no classical equivalent. The Pauli Exclusion Principle — no two identical fermions in the same quantum state — is why matter occupies space and why the periodic table works.",
        detail: `Spin is not the particle physically rotating — it is an intrinsic quantum property, like charge, that particles simply have.\n\n<strong>Electron spin:</strong>\nSpin quantum number s = ½. Measured spin along any axis = +ħ/2 or −ħ/2.\nWe call these spin-up (↑) and spin-down (↓), but these labels are just conventions for the two eigenvalues.\n\n<strong>Why spin matters:</strong>\nElectrons are magnetic dipoles because of spin — spinning charge creates a magnetic moment.\nMagnetic moment: μ = −g_e·μ_B·S (g_e ≈ 2, μ_B = Bohr magneton)\nThis is the basis of MRI (nuclear spin of hydrogen) and electron spin resonance spectroscopy.\n\n<strong>Fermions vs. bosons:</strong>\nAll particles have either half-integer spin (½, 3/2, ...) — called fermions — or integer spin (0, 1, 2, ...) — called bosons.\n• Fermions: electrons, protons, neutrons, quarks. Obey Pauli Exclusion Principle.\n• Bosons: photons, W/Z bosons, Higgs. Can all occupy the same quantum state.\n\n<strong>Pauli Exclusion Principle:</strong>\nNo two identical fermions can occupy the same quantum state simultaneously.\nConsequences:\n• Electrons fill atomic shells — can't all crowd into n=1 ground state\n• This builds up the periodic table from hydrogen upward\n• Electrons in metals resist compression (degeneracy pressure) — this is why solid matter is solid and why white dwarf stars don't collapse (electron degeneracy pressure)\n\n<strong>Bose-Einstein Condensate (BEC):</strong>\nBosons have no Pauli restriction. At ultracold temperatures (~100 nK), bosons all collapse into the same ground state — a new state of matter where all particles behave as one quantum entity. Predicted 1924, demonstrated 1995 (Nobel Prize 2001).\n\n<strong>Superfluidity and superconductivity:</strong>\nBEC-like phenomena where quantum statistics enable frictionless flow of particles (superfluid helium) or electrons (superconductors).`,
        memory: `Why can't you push your hand through a table? Not because of electromagnetic repulsion alone — it's the Pauli Exclusion Principle. The electrons in your hand cannot occupy the same states as electrons in the table. They resist compression into shared states. The "hardness" of matter is fundamentally a quantum statistical effect, not a classical force. Without Pauli exclusion, all matter would collapse to a point.`,
        examTip: `NMR spectroscopy (and MRI) exploits nuclear spin. Proton nuclei (spin-½) align in a magnetic field into two energy states (parallel and antiparallel). A radiofrequency pulse flips them. The frequency at which they absorb energy depends on the local chemical environment — giving structural information about neighboring atoms. NMR is one of the primary tools for determining protein structure in solution. Spin is not a physics curiosity — it's a daily tool in structural biology labs.`,
        facts: ["Spin is intrinsic — not physical rotation", "Electron spin: s = ½ (+½ or −½)", "Fermions: half-integer spin, obey Pauli", "Bosons: integer spin, no Pauli restriction", "Pauli exclusion makes matter solid", "BEC: bosons all in ground state at ~100 nK"]
      },
